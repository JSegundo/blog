...
export const metadata: Metadata = {
  title: "Projects",
  description: "A collection of projects and products I've built.",
}
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
      ...
      <p className="text-lg text-[var(--text-secondary)] mb-12">
        Products and platforms I&apos;ve designed and built.
      </p>
        ...
        {projects.map((project) => {
          ...
          return (
            <Link key={project.slug} href={href}>
              <div className="group flex flex-col md:flex-row gap-6 p-6 md:p-8 rounded-2xl border border-[var(--border)] bg-[var(--bg-secondary)] hover:border-[var(--accent)] transition-colors duration-300">
                {/* Inline Preview */}
                <div className="relative w-full md:w-1/2 h-56 md:h-72 flex-shrink-0">
                  {/* Desktop: overlapping layout */}
                  <div className="hidden md:block relative w-full h-full">
                    {/* Dashboard frame (behind) */}
                    ...
                    <div className="absolute top-4 left-0 w-[42%] h-[90%] rounded-2xl border-2 border-[var(--border)] bg-[var(--bg-primary)] shadow-xl overflow-hidden z-10">
                      ...
                      <div className="px-3 py-2">
                        <p className="text-[9px] font-medium text-[var(--text-primary)] leading-tight">Are you currently taking any blood thinners?</p>
                      </div>
                ...
                <div className="flex flex-col justify-center flex-1">
                  ...
                  <h2 className="font-heading text-2xl md:text-3xl font-semibold text-[var(--text-primary)] mb-4">
                    {project.title}
                  </h2>
